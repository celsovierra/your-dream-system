...
export const mockTemplates: MessageTemplate[] = [
  ...
  { id: 2, name: 'Vencimento', type: 'due', content: 'Olá *{nome}*!\n\nSua mensalidade está disponível para pagamento.\n\n📅 *Vencimento:* {data_vencimento}\n💰 *Valor:* R$ {valor}\n\nPague agora pelo PIX:\n{link_pagamento}\n\n_Após o pagamento, você receberá seu recibo automaticamente._', is_active: true, created_at: '2024-01-01' },
