...
router.post('/deploy', (req, res) => {
  ...
  const command = `cd /opt/cobranca-pro && git pull && npm install && npm run build && mysql -u cobranca_admin -p'Xk9mL2vR7pQ4nW' cobranca_pro < database/schema.sql && sudo systemctl restart nginx`;
